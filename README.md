...
1. [The paper: What the Web Could Have Been](https://clean-room-web.project802.io/what-the-web-could-have-been/). The full argument: how the web accreted, the two structural problems underneath it, and the architecture that avoids them. Read it as a typeset page that renders with no scripts and no runtime, the same property the paper argues a document should have, or read the [source Markdown](./architecture/paper/what-the-web-could-have-been.md).
...
This is not a pitch, and the paper does not pretend the design is free. It treats its real limitations directly: the install-base moat that makes adoption near-impossible, the migration burden, the unsettled seam where documents meet embedded app islands, and the user-agency cost of moving layout out of the engine. See the paper's [Limitations](./architecture/paper/what-the-web-could-have-been.md#limitations) section. Naming these is part of the point: the value of the proof is not that it ships, it is that it shows an alternative was possible.
